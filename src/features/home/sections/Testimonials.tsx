          ...
          <div className="chat-shell overflow-hidden">
            ...
            <div className="chat-body space-y-4 sm:space-y-5 px-3 sm:px-6 md:px-8 py-6">
              {messages.map((msg, idx) => (
                <div key={`${msg.name}-${msg.time}`} className={`flex ${msg.side === "right" ? "justify-end" : "justify-start"}`}>
                  <div
                    className={`bubble max-w-xl rounded-2xl px-4 py-3 text-sm shadow-lg ${
                      msg.side === "right" ? "bg-[#d9fdd3] text-gray-800" : "bg-white/95 text-gray-800"
                    }`}
                  ...
                  >
                    ...
                    {msg.side === "right" && (
                      <div className="mt-2 flex items-center gap-1 text-[11px] text-gray-500">
                        <svg className="w-4 h-4 text-[#53bdeb]" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
