...
export default function Benefits() {
  ...
  return (
    <section className="relative py-24 bg-white overflow-hidden">
      <div
        className="absolute inset-x-0 top-14 h-1 slow-gradient-bar"
        aria-hidden
      />
      <div
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="mt-6 text-lg sm:text-xl text-slate-600 leading-relaxed">
            Un bloque de beneficios diseñado para transmitir precisión médica,
            calidez humana y resultados visibles desde la primera sesión.
          </p>
        </div>
        ...
        <div className="mt-20 flex justify-center">
          <div className="relative overflow-hidden rounded-2xl border border-white/80 bg-white/90 shadow-[0_20px_60px_rgba(0,0,0,0.08)] px-8 py-10 max-w-2xl w-full text-center">
            <div
              className="absolute inset-0 slow-gradient-bar opacity-40"
              aria-hidden
            />
            <div className="relative z-10">
              ...
              <p className="text-slate-600 mb-6 leading-relaxed">
                Agenda tu valoración y diseñemos un plan preciso, con resultados
                visibles y recuperación guiada.
              </p>
              <a
