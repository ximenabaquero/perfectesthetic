      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-14">
          ...
          <p className="text-lg sm:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            Estamos aquí para resolver tus dudas y diseñar un plan con precisión
            médica y calidez humana.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {socialLinks.map((link, index) => (
              <a
                ...
                className={`group soft-gradient-border contact-card ${
              ...
              >
                <div className="soft-gradient-border__inner card-sheen rounded-3xl p-8 text-center h-full relative overflow-hidden">
                  ...
                  />
                  <div
                    className={`relative mx-auto mb-5 w-16 h-16 rounded-full ${link.color} flex items-center justify-center shadow-[0_18px_45px_rgba(214,150,200,0.28)] transform transition-transform duration-300 ease-out group-hover:scale-105`}
                  >
          ...
          <div className="cta-banner rounded-3xl p-8 sm:p-12 text-white text-center shadow-[0_30px_80px_rgba(168,118,189,0.32)] relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-3xl sm:text-4xl font-semibold mb-5 tracking-tight">
                ¡Comienza tu transformación hoy!
              </h3>
              <p className="text-lg sm:text-xl mb-7 opacity-90 max-w-3xl mx-auto leading-relaxed">
                Agenda tu consulta gratuita y descubre cómo la lipólisis láser y
                nuestros protocolos médicos pueden cambiar tu perfil corporal.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="cta-button-animated inline-flex items-center gap-3 bg-[#25D366] px-6 sm:px-8 py-3.5 rounded-full text-white font-semibold text-base sm:text-lg transform transition-transform duration-300 ease-out hover:scale-105"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                <a
                  ...
                  className="cta-button-animated inline-flex items-center gap-3 bg-white/90 text-[#b14ccf] px-6 sm:px-8 py-3.5 rounded-full font-semibold text-base sm:text-lg shadow-[0_18px_42px_rgba(255,255,255,0.22)] transform transition-transform duration-300 ease-out hover:scale-105"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
        ...
        <div className="text-center mt-16 pt-10 border-t border-gray-200">
          <div className="mb-4">
            <h3 className="text-2xl font-semibold text-[#b977a3] mb-1">
              Perfestetic
            </h3>
